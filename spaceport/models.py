...
class Result(models.Model):
    ...
    image_previous_url = models.CharField(max_length=400, null=True)
    image_visual_url = models.CharField(max_length=400, null=True)
    image_analytics_url = models.CharField(max_length=400, null=True)
    image_metadata_url = models.CharField(max_length=400, null=True)
